      ...
      >
        ...
        <div className="relative z-10 h-full flex flex-col justify-between p-5">
          <div className="flex items-start justify-between">
            <div className="relative">
              ...
              >
                <motion.svg
                  ...
                  className="text-[#2BC8B7]"
                  animate={{
                    filter: isHovered
                      ? "drop-shadow(0 0 8px rgba(155, 153, 254, 0.6))"
                      : "drop-shadow(0 0 4px rgba(155, 153, 254, 0.3))",
                  }}
                  transition={{ duration: 0.3 }}
                >
            ...
            >
              <div className="w-1.5 h-1.5 rounded-full bg-[#2BC8B7]" />
              <span className="text-[10px] font-medium text-muted-foreground tracking-wide uppercase">Available</span>
            </motion.div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <motion.div
              className="h-px bg-gradient-to-r from-[#9B99FE]/50 via-[#2BC8B7]/30 to-transparent"
